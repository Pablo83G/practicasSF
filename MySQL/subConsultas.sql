/* Una subconsulta es una instrucción SELECLT dentro de una instrucción SELECT, SELECT...
 INTO, INSERT...INTO, DELETE o UPDATE o dentro de una subconsulta*/
...
drop table if exists detalles;
 ...
 select distinct f.cliente, f.numero  
 from facturas as f
 join detalles as d
