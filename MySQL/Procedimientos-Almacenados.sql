...
call pa_libros_autor('Mario Molina');
...
call pa_libros_autor_editorial('Lewis Carroll', 'Emece');
call pa_libros_autor_editorial('Lewis Carroll', 'Plaza');
...
call pa_autor_totalypromedio('Richard Bach', @suma, @media);
-- se introduce el parametro de entrada y dos variables con @nombre donde se almacenan los parametros de salida
select @suma as suma, @media as media;

drop procedure if exists pa_autor_totalypromedio;