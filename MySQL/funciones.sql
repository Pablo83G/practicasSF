...
select * from productos where proveedor regexp '[o]';
select * from productos where proveedor regexp '[a-d]'; -- De la "a" a la "d"
select * from productos where proveedor regexp '^D'; -- Comienza con una letra
select * from productos where nombre regexp 'a.*a';

#Funcion count

select * from productos;
select count(*) from productos; -- devuelve cuantos registros tenemos 

select count(*) from productos where proveedor = 'HP';
select count(*) from productos where descripcion like '%laptop%';
select count(*) from productos where proveedor regexp 'logitech';
...
select avg(precio) from productos where nombre like '%Laptop%'; -- calcula el promedio 
...
-- agrupa los registros duplicados
select * from productos;
